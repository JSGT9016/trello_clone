...
import com.example.projectmangapp.activities.TaskListActivity
...
open class TaskListItemAdapter(
        ...
        if(holder is MyViewHolder){
            ...
            holder.itemView.ib_done_list_name.setOnClickListener {
                ...
                if(listName.isNotEmpty()){
                    ...
                    Toast.makeText(context,"No se pueden crear listas sin nombre...",Toast.LENGTH_LONG).show()
                }
            }

            holder.itemView.ib_edit_list_name.setOnClickListener {
                holder.itemView.et_edit_tast_list_name.setText(model.title)
                holder.itemView.ll_tittle_view.visibility = View.GONE
                holder.itemView.cv_edit_task_list_name.visibility = View.VISIBLE
            }

            holder.itemView.ib_close_editable_view.setOnClickListener {
                holder.itemView.ll_tittle_view.visibility = View.VISIBLE
                holder.itemView.cv_edit_task_list_name.visibility = View.GONE
            }

            holder.itemView.ib_done_edit_list_name.setOnClickListener {
                val listName = holder.itemView.et_edit_tast_list_name.text.toString()
                if(listName.isNotEmpty()){
                    if(context is TaskListActivity){
                        context.updateTaskListName(position, listName, model)
                    }
                }
                else{
                    Toast.makeText(context,"Por favor, ingresa un nombre valido para la lista", Toast.LENGTH_LONG).show()
            ...
            holder.itemView.ib_done_card_name.setOnClickListener {
                ...
                if(cardName.isNotEmpty()){
                    ...
                    Toast.makeText(context,"Por favor, ingresa un nombre valido para la carta", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private fun alertDialogForDeleteList(position:Int, title:String){
        ...
        builder.setMessage("¿Estas seguro de eliminar la lista \"${title}\"?")
